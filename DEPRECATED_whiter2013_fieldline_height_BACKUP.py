...
class Config:
    ...
    footprint_alt: float = 100.0  # map LYR cluster to lat/lon at this height, then IGRF [km]
    ...
    bright_pct: float = 5.0  # cluster the brightest this % of FOV pixels (Whiter)
...
def main(argv=None) -> int:
    ...
    print(f"  seed alt  : {cfg.footprint_alt:g} km (LYR cluster → lat/lon, then IGRF)")
